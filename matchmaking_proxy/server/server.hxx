...
public:
  ...
  boost::asio::awaitable<void> userMatchmaking (boost::asio::ip::tcp::endpoint const &endpoint, std::filesystem::path const &pathToSecrets, MatchmakingOption const &matchmakingOption);
