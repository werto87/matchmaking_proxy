...
public:
  ...
  boost::asio::awaitable<void> userMatchmaking (boost::asio::ip::tcp::endpoint endpoint, std::filesystem::path const &pathToSecrets, MatchmakingOption const &matchmakingOption, boost::asio::ip::tcp::endpoint matchmakingGameEndpoint, boost::asio::ip::tcp::endpoint userGameViaMatchmakingEndpoint);
