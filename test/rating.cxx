...
TEST_CASE ("updateRatingWinLose", "[rating]")
{
  ...
  {
    auto const losers = std::vector<database::Account>{ { 0, "", "player1", "", 1500 } };
    auto const winners = std::vector<database::Account>{ { 0, "", "player2", "", 2000 } };
  ...
  {
    auto const losers = std::vector<database::Account>{ { 0, "", "player1", "", 2000 } };
    auto const winners = std::vector<database::Account>{ { 0, "", "player2", "", 1000 }, { 0, "", "player3", "", 1000 }, { 0, "", "player4", "", 1000 } };
    auto const [updatedLosers, updatedWinners] = calcRatingLoserAndWinner (losers, winners);
...
TEST_CASE ("updateRatingDraw", "[rating]")
{
  ...
  {
    auto const accounts = std::vector<database::Account>{ { 0, "", "player1", "", 1500 }, { 0, "", "player2", "", 2000 } };
  ...
  {
    auto const accounts = std::vector<database::Account>{ { 0, "", "player1", "", 1500 }, { 0, "", "player2", "", 2000 }, { 0, "", "player3", "", 2000 } };
    auto const updatedAccounts = calcRatingDraw (accounts);
  ...
  {
    auto const accounts = std::vector<database::Account>{ { 0, "", "player1", "", 1000 }, { 0, "", "player2", "", 2000 }, { 0, "", "player3", "", 1000 }, { 0, "", "player4", "", 1000 } };
    auto const updatedAccounts = calcRatingDraw (accounts);
  ...
  {
    auto const accounts = std::vector<database::Account>{ { 0, "", "player1", "", 2000 }, { 0, "", "player2", "", 2000 }, { 0, "", "player3", "", 2000 }, { 0, "", "player4", "", 1000 } };
    auto const updatedAccounts = calcRatingDraw (accounts);
  ...
  {
    auto const accounts = std::vector<database::Account>{ { 0, "", "player1", "", 2000 }, { 0, "", "player2", "", 2000 }, { 0, "", "player3", "", 1 }, { 0, "", "player4", "", 1 } };
    auto const updatedAccounts = calcRatingDraw (accounts);
